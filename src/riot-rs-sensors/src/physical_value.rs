...
/// sensor device is `22.25` (the [measurement error](AccuracyError) must additionally
...
///
/// The `AccuracyError` should be obtained quickly after obtaining the `PhysicalValue`, as the
/// accuracy can be affected by in a change of the internal state of the sensor driver.
#[derive(Debug, Copy, Clone, PartialEq, serde::Serialize)]
