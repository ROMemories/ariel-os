...
/// physical value.
/// This allows consumers displaying the label to ignore it for sensor drivers returning a single physical value.
/// Other labels are reserved for sensor drivers returning multiple physical values.
#[derive(Debug, Copy, Clone, PartialEq, Eq, serde::Serialize)]
pub enum Label {
    /// Used for sensor drivers returning a single physical value.
    Main,
    /// Humidity.
    Humidity,
    /// Temperature.
