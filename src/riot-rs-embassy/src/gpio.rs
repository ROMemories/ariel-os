...
pub use riot_rs_shared_types::gpio::{DriveStrength, Level, Pull, Speed};
...
pub mod input {
    ...
    use riot_rs_shared_types::gpio::Pull;
    ...
    pub use riot_rs_shared_types::gpio::input::Error;

    #[cfg(feature = "external-interrupts")]
    pub use riot_rs_shared_types::gpio::input::InterruptError;
...
pub mod output {
    ...
    use riot_rs_shared_types::gpio::{DriveStrength, FromDriveStrength, FromSpeed, Level, Speed};
