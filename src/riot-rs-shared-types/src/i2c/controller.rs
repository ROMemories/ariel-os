...
macro_rules! impl_i2c_from_frequency {
    () => {
        impl From<riot_rs_shared_types::i2c::controller::Frequency> for Frequency {
            fn from(freq: riot_rs_shared_types::i2c::controller::Frequency) -> Self {
                match freq {
                    riot_rs_shared_types::i2c::controller::Frequency::_100k => Frequency::_100k,
                    riot_rs_shared_types::i2c::controller::Frequency::_400k => Frequency::_400k,
                }
            }
        }
    };
...
macro_rules! impl_i2c_from_frequency_up_to {
    () => {
        impl From<riot_rs_shared_types::i2c::controller::Frequency> for Frequency {
            fn from(freq: riot_rs_shared_types::i2c::controller::Frequency) -> Self {
                match freq {
                    riot_rs_shared_types::i2c::controller::Frequency::_100k => {
                        Frequency::UpTo100k(100)
                    }
                    riot_rs_shared_types::i2c::controller::Frequency::_400k => {
