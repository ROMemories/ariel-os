...
## Printing on the Debug Output

When the `logging-over-debug-output` [laze module][laze-modules-book] is enabled, [logs][logging-book] are printed on the debug output.
